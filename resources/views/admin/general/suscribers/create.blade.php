        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h4 class="card-title">Nuevo Evento Expirado</h4>
                        </div>
                        <div class="col-12">
                    ...
                    {!! Form::open(['url'=>route('expired.store'), 'method'=>'POST', 'files'=>true, 'class'=>'row']) !!}
                        <div class="col-md-12 loading-wrapper">
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-4 text-center">
                                    <button class="btn btn-primary">Crear Evento Expirado</button>
                                </div>
                            </div>
                        </div>
                    {!! Form::close() !!}
