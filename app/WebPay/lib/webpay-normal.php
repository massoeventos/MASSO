...
class WebPayNormal {
    ...
    function logWP( $result, $title = "" ){
        $path = explode('/', __FILE__); unset($path[sizeof($path)-1]);
        $path = implode('/', $path);
        $path = $path.'/logs/transaction.log';
    ...
    function _getTransactionResult($getTransactionResult) {
        $this->logWP( $getTransactionResult, 'getTransactionResult REQUEST' );
    ...
    function _acknowledgeTransaction($acknowledgeTransaction) {
        $this->logWP( $acknowledgeTransaction, 'acknowledgeTransaction REQUEST' );
    ...
    function _initTransaction($initTransaction) {
        ...
        $this->logWP( $initTransaction, 'initTransaction REQUEST' );
    ...
    public function initTransaction($amount, $buyOrder, $sessionId , $urlReturn, $urlFinal) {
        ...
        try {
            ...
            if ($validationResult === TRUE) {
                ...
                $this->logWP( $wsInitTransactionOutput, 'initTransaction RESPONSE' );
    ...
    public function getTransactionResult($token) {
        ...
        try {
            ...
            if ($validationResult === TRUE) {
                ...
                $this->logWP( $transactionResultOutput, 'transactionResult RESPONSE' );
    ...
    public function getTransactionResultWithoutACK($token) {
